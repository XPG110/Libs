...
import com.example.nanfu.libs.view.loadingview.LoaderImageView;
import com.example.nanfu.libs.view.loadingview.LoaderTextView;
...
public class LoadActivity extends Activity {
    ...
    private void postLoadData() {
        ...
        ((ImageView) findViewById(R.id.image_icon)).setImageResource(R.mipmap.trump);
    }
